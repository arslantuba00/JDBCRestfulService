...
public class Ders_Ogrenci {
	...
	public Ders_Ogrenci(long iD, long oGR_ID, long dERS_ID, long dEVAMSIZLIK, long nOT) {
		ID = iD;
		OGR_ID = oGR_ID;
		DERS_ID = dERS_ID;
	...
	public String toString() {
		return "Ders_Ogrenci [ID=" + ID + ", OGR_ID=" + OGR_ID + ", DERS_ID=" + DERS_ID + ", DEVAMSIZLIK=" + DEVAMSIZLIK
				+ ", NOT=" + NOT + "]";
	}
